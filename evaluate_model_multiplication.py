...
def evaluate(args):    
    ...
    min_n_digits_1 = args.min_n_digits_1
    max_n_digits_1 = args.max_n_digits_1
    min_n_digits_2 = args.min_n_digits_2
    max_n_digits_2 = args.max_n_digits_2
    eval_step_digits_1 = args.step_digits_1
    eval_step_digits_2 = args.step_digits_2
    ...
    cfg.task.train.min_n_digits_1=1
    cfg.task.train.max_n_digits_1=1
    cfg.task.train.min_n_digits_2=2
    cfg.task.train.max_n_digits_2=2
    cfg.task.train.n_data=1
    # cfg.task.train.randomize=False
    cfg.task.val.min_n_digits_1=1
    cfg.task.val.max_n_digits_1=1
    cfg.task.val.min_n_digits_2=2
    cfg.task.val.max_n_digits_2=2
    cfg.task.val.n_data=1
    cfg.task.val_long_first.min_n_digits_1=1
    cfg.task.val_long_first.max_n_digits_1=1
    cfg.task.val_long_first.min_n_digits_2=2
    cfg.task.val_long_first.max_n_digits_2=2
    cfg.task.val_long_first.n_data=1
    cfg.task.val_long_second.min_n_digits_1=1
    cfg.task.val_long_second.max_n_digits_1=1
    cfg.task.val_long_second.min_n_digits_2=2
    cfg.task.val_long_second.max_n_digits_2=2
    cfg.task.val_long_second.n_data=1

    for n_digits_1 in reversed(range(min_n_digits_1, max_n_digits_1+1, eval_step_digits_1)):
        losses_ = []
        tokenwise_accuracies_ = []
        instancewise_accuracies_ = []
        answerwise_accuracies_ = []
        for n_digits_2 in reversed(range(min_n_digits_2, max_n_digits_2+1, eval_step_digits_2)):
            # try:
            cfg.task.val_long.min_n_digits_1 = n_digits_1
            cfg.task.val_long.max_n_digits_1 = n_digits_1
            cfg.task.val_long.min_n_digits_2 = n_digits_2
            cfg.task.val_long.max_n_digits_2 = n_digits_2
            print(f"#digits_1={n_digits_1}\n#digits_2={n_digits_2}")
            ...
            print(f"seed({cfg.seed},{cfg.seed_data}) #digits_1={n_digits_1} #digits_2={n_digits_2}"
                  f" Loss {loss_avg:.6f}"
            ...
            #     print(e)
            #     print(f"#digits={n_digits_1} #operands={n_digits_2} Loss {None} TokenAcc {None} InstAcc {None}")
            #     losses_.append(None)
    ...
    # Save loggings
    n_digits_1_arr = list(range(min_n_digits_1, max_n_digits_1+1, eval_step_digits_1))
    n_digits_2_arr = list(range(min_n_digits_2, max_n_digits_2+1, eval_step_digits_2))
    perf_dict = {
        'n_digits_1': n_digits_1_arr,
        'n_digits_2': n_digits_2_arr,
        'losses': losses[::-1],
